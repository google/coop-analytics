...
/*
 * Create a view containing the fullVisitorIDs of visitors who add products to their basket.
 *
 ...
 */
CREATE OR REPLACE VIEW `coop_analytics.ConversionsAddToBasket` AS (
  SELECT
